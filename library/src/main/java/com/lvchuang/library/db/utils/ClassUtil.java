...
import com.lvchuang.library.db.annotate.Table;
...
public class ClassUtil {
    ...
    public static Object getPrimaryKeyValue(Object entity) {
        return FieldUtil.getFieldValue(entity,
                ClassUtil.getPrimaryKeyField(entity.getClass()));
    }
            ...
            for (Field f : fs) {
                ...
                if (!FieldUtil.isTransient(f)) {
                    if (FieldUtil.isBaseDateType(f)) {
                        ...
                        property.setDefaultValue(FieldUtil
