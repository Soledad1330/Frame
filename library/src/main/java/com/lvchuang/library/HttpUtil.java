...
import com.lvchuang.library.http.builder.GetBuilder;
import com.lvchuang.library.http.builder.HeadBuilder;
import com.lvchuang.library.http.builder.OtherRequestBuilder;
import com.lvchuang.library.http.builder.PostFileBuilder;
import com.lvchuang.library.http.builder.PostFormBuilder;
import com.lvchuang.library.http.builder.PostStringBuilder;
import com.lvchuang.library.http.callback.Callback;
import com.lvchuang.library.http.cookie.CookieJarImpl;
import com.lvchuang.library.http.cookie.store.CookieStore;
import com.lvchuang.library.http.cookie.store.HasCookieStore;
import com.lvchuang.library.http.cookie.store.MemoryCookieStore;
import com.lvchuang.library.http.request.RequestCall;
import com.lvchuang.library.http.utils.Exceptions;
import com.lvchuang.library.http.utils.HttpsUtils;
import com.lvchuang.library.http.utils.LoggerInterceptor;
...
public class HttpUtil {
    ...
    public HttpUtil debug(String tag) {
     ...
     * @return
     */
    public HttpUtil debug(String tag, boolean showResponse) {
        mOkHttpClient = getOkHttpClient().newBuilder().addInterceptor(new LoggerInterceptor(tag, showResponse)).build();
        return this;
    }

    public static HttpUtil getInstance(OkHttpClient okHttpClient) {
        if (mInstance == null) {
