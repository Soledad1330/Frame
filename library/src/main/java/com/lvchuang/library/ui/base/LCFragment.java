 ...
 * Description:Fragment基类,规范了Fragment的逻辑顺序与生命周期
 */
public abstract class LCFragment extends Fragment implements View.OnClickListener {
    ...
    private class FragmentHandler extends Handler {
        private final SoftReference<LCFragment> outerInstance;

        public FragmentHandler(LCFragment outer) {
            outerInstance = new SoftReference<LCFragment>(outer);
        }
